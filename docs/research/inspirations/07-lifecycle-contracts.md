...
- **Exit codes never block**: post-create failure is "reported, notfatal — the worktree already exists"; pre-remove failure "warns but never blocks rmoval — the user asked to delete and a broken script should not hold that hostage."
