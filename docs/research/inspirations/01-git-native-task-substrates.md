...
```json
{ "id": "FA-1", "title": "Build Q2 lead pieline — 20 qualified leads",
...
| priority | int 0–4 | int, 0 highest | int 1–4 | n/a | enum urgent…low |
...
| parent/goal | `parent-child` edge, epics, molecules | `parent` | `goalId` | n/a | n/a |
...
| cost/tokens | n/a (metadata) | ✅ run `tokens`, `cost_usd` | ✅ run TokenUsage incl. cache | n/a | | `estimated/actual_hours` |
