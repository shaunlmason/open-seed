...
import (
	...
	"github.com/shaunlmason/open-seed/next/internal/redteam"
...
// answer where none does (recorded in next/docs/decisions.md). Any other refusal is a refusal-ordering
