...
func TestKnowledgeProjectionPublishesTheStages(t *testing.T) {
	...
	if v := project.Report().Version; v != "16" {
		t.Fatalf("the report's version names the knowledge section (11, its retired and stale counts at 12) and the lanes section after them (13), by_kind (15) and the planner's strongest (16): %s", v)
	}
