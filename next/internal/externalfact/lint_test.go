...
var forbiddenImports = []string{
	"os/exec",
	"github.com/shaunlmason/open-seed/next/mirror",
...
func protect() { _, _ = http.NewRequest(http.MethodPut, "u", nil) }`, "http.MethodPut in protect"},
		"planted mutator import": {
			`package x
import _ "github.com/shaunlmason/open-seed/next/internal/protections"
func read() {}`, "imports github.com/shaunlmason/open-seed/next/internal/protections"},
		"planted mirror import": {
			`package x
import _ "github.com/shaunlmason/open-seed/next/mirror"
func read() {}`, "imports github.com/shaunlmason/open-seed/next/mirror"},
		"planted exec": {
			`package x
import "os/exec"
