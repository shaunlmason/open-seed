...
// (plans/os-f0ae2cdf.md step 3; next/spec/offers.md): the eligibility
...
// inert at every consuming surface (next/spec/offers.md "Foreign
// offers are inert").
...
// (next/executor: "its total failure costs latency, never
// correctness").
